    ...
    if(this.state.password !== this.state.confirmPassord){
      alert("confirm password")
        ...
        $.ajax({
          ...
          success: (data) => {
            console.log(data ==="1")
            if(data === "1"){console.log("aazazaz")}
            if(data === "0"){alert("Please verify your password")}
            if(data === "2"){alert("Account Created you can Login")}
          },
          error: (err) => {
      ...
      render () {
       ...
       <form onSubmit={this.handleSubmit}>
              ...
              <label>Phone Number:
              <input type="text" placeholder="Phone Number" name="phoneNumber" value={phoneNumber} onChange={this.handleChange}/>
              </label>
              <label>Email:
              ...
              <input type="password" placeholder="enter your password" name="confirmPassord" value={confirmPassord} onChange={this.handleChange}/>
              </label>
